...
public class Tile {
   ...
   private static final Color tileColor = new Color(120, 38, 157);
   // the color used for the number on the tile (a static constant)
   private static final Color numberColor = new Color(178, 184, 238);
   // the color used for the box around the tile (a static constant)
   private static final Color boxColor = new Color(178, 184, 238);
   ...
   private static final Font numberFont = new Font("TimesNewRoman", Font.BOLD, 50);
